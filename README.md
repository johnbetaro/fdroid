...
| --- | --- | --- | --- |
| <a href="https://github.com/johnbetaro/Signal-AMOLED"><img src="fdroid/repo/icons/" alt="Signal AMOLED icon" width="36px" height="36px"></a> | [**Signal AMOLED**](https://github.com/johnbetaro/Signal-AMOLED) | A fork of Signal private messenger that replaces the classic dark theme with ... | 7.38.4 (152700) |
<!-- end apps table -->
